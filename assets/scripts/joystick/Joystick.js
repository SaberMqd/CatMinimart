...
cc.Class({
    ...
    properties: {
        ...
        joystickType: {
            default: JoystickEnum.JoystickType.FOLLOW,
        ...
        showJoystic: {
            default: JoystickEnum.ShowJoystic.Yes,
            type: JoystickEnum.ShowJoystic,
            displayName: 'Show Joystic',
            tooltip: '显示摇杆',
        },
    ...
    onLoad() {
        ...
        this._location = this.ring.getPosition();
    ...
    _touchEndEvent(event) {
        ...
        if (this.joystickType === JoystickEnum.JoystickType.FOLLOW) {
            this.ring.setPosition(this._location);
